...
public class User implements Serializable {
    ...
    private Integer id;
    //    This denotes that the id variable will be our unique identifier and will be automatically generated
    private String username;
    @Column(unique = true)
    private String email;
    //    This states email must be unique, or it'll be rejected.
    private String password;
    @Transient
    boolean loggedin;
//    Transient means we don't want Spring Data JPA to keep this info in the database.

//    FetchType.EAGER means this list will gather all the info immediately after creation. Only one list can be EAGER.
